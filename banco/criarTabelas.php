<?php
  ...
  $filiados = "CREATE TABLE filiados (
    ...
    $candidatos = "CREATE TABLE candidatos (
      ...
      nm_tipo_eleicao VARCHAR(4000),
      nr_turno INT(2),
      cd_eleicao INT(4),
      ds_eleicao VARCHAR(4000),
      dt_eleicao DATE,
      tp_abrangencia VARCHAR(5),
      sg_uf VARCHAR(2),
      sg_ue VARCHAR(2),
      nm_ue VARCHAR(50),
      cd_cargo INT(2),
      ds_cargo VARCHAR(4000),
      sq_candidato BIGINT(100),
      nr_candidato BIGINT(100),
      nm_candidato VARCHAR(5000),
      nm_urna_candidato VARCHAR(5000),
      nr_cpf_candidato BIGINT(15),
      nm_email VARCHAR(4000),
