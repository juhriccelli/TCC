...
foreach($arquivos as $ext){
  ...
  while(!feof($arquivo)) {
    ...
    if($dados[0] != 'DATA_GERACAO' && !empty($linha)) {
      //Verifica o ano da eleição para melhor preenchimento dos dados.
      if ($ano >= 2016) {
        ...
        $sql = "INSERT INTO eleicoes (dt_geracao, hh_geracao, ano_eleicao, cd_tipo_eleicao, nm_tipo_eleicao,
          ...
          elseif ($ano == 2014) {
            ...
            $cd_tipo_eleicao = NULL;
            $nm_tipo_eleicao = NULL;
            $cd_eleicao = NULL;
            $dt_eleicao = NULL;
            $tp_abrangencia = NULL;
            $nm_ue = NULL];
            $nm_social_candidato = NULL;
            $cd_detalhe_situacao_cand = NULL;
            $ds_detalhe_situacao_cand = NULL;
            $tp_agremiacao = NULL;
          ...
          }//Fecha o IF do outros anos



        }//Fecha o IF de verificação do cabeçalho
        }//Fecha o while
        fclose($arquivo);
      };//Fecha o foreach
